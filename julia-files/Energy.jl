...
module Energy
    ...
    #
    # out: Float
    function energy(mat::Array{AbstractFloat,3}, params)
    ...
    #
    # out: float
    function zeeman_energy(mat::Array{AbstractFloat,3}, h::AbstractFloat)
    ...
    #
    # out: float
    function dmi_energy(mat::Array{AbstractFloat,3}, a::AbstractFloat, pbc)
    ...
    #
    # out: float
    function exchange_energy(mat::Array{AbstractFloat,3}, J::AbstractFloat,
        pbc::Bool, dParams)
    ...
    #
    # out: float
    function ddi_energy(mat::Array{AbstractFloat,3}, ed::AbstractFloat,
        pbc::AbstractFloat, phiMatrices::Array{Array{AbstractFloat,2},1})

        p, m, n     = size(mat)
        ddiEnArray  = Array{AbstractFloat}(undef,p,m,n)
    ...
    #
    # out: float
    function pma_energy(mat::Array{AbstractFloat,3}, dz::AbstractFloat)
